...
var (
	...
	TWCC = TWCCConfig{
		...
		RerankEnabled: getBoolEnv("TWCC_RERANK_ENABLED", true),
		RerankModel:   getEnv("TWCC_RERANK_MODEL", getEnv("TWCC_MODEL", "llama3.3-ffm-70b-32k-chat")),
		RerankTopK:    getIntEnv("TWCC_RERANK_TOP_K", 30),
		RerankTimeout: getIntEnv("TWCC_RERANK_TIMEOUT", getIntEnv("TWCC_TIMEOUT", 60)),
	}
