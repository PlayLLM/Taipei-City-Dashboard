...
dockerCp(
  "data/taipei_cup_count.csv",
  config.dataContainer,
  "/tmp/taipei_cup_count.csv",
);
dockerCp(
...
dockerCp(
  "db-sample-data/add_green_store_data.sql",
  config.dataContainer,
  "/tmp/add_green_store_data.sql",
);
dockerCp(
  "data/臺北市綠色商店1130429.csv",
  config.dataContainer,
  "/tmp/green_store_tpe.csv",
);
dockerCp(
  "data/新北市綠色商店1130429.csv",
  config.dataContainer,
  "/tmp/green_store_new_tpe.csv",
);
...
psql(config.dataContainer, config.dashboardDb, "/tmp/add_green_store_data.sql");
